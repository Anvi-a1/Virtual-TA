---
title: "Code context engineering"
original_url: "https://tds.s-anand.net/#/ai-coding-context?id=spec-first-development"
downloaded_at: "2025-11-17T01:53:36.424384"
---
[AI Coding Context Engineering](#/ai-coding-context?id=ai-coding-context-engineering)
=====================================================================================
...
* [**File context**](#/ai-coding-context?id=file-context): Techniques for providing relevant code snippets and files to AI tools
* [**Spec-first development**](#/ai-coding-context?id=spec-first-development): Using a specification document as the single source of truth for AI-driven development
* [**Project context**](#/ai-coding-context?id=project-context): Using `CLAUDE.md` or `AGENTS.md` to give AI persistent knowledge about your codebase
* [**Library context**](#/ai-coding-context?id=library-context): Supplying documentation for third-party libraries to improve AI understanding
* [**Project documentation**](#/ai-coding-context?id=project-documentation): Generating and maintaining human and AI-readable docs for better collaboration
* [**llms.txt**](#/ai-coding-context?id=llmstxt): Implementing the llms.txt standard to help LLMs understand your website or API
* [**Instruction templates**](#/ai-coding-context?id=instruction-templates): Using lightweight schemas to eliminate ambiguity in prompts
* [**Best practices and tips**](#/ai-coding-context?id=best-practices-and-tips): Maintaining context hygiene, cost optimization, and team collaboration
...
[File context](#/ai-coding-context?id=file-context)
---------------------------------------------------
...
```
uvx files-to-prompt --cxml file1.py file2.js repo/ ...Copy to clipboardErrorCopied
```
...
```
uvx gitingest https://github.com/sanand0/tools-in-data-science-publicCopy to clipboardErrorCopied
```

[Spec-first development](#/ai-coding-context?id=spec-first-development)
-----------------------------------------------------------------------
...
1. **Meta**: *Status*, *Version*, *Owners*, *Repo/Issue links*, *Last reviewed*
2. **Problem & Scope**: One-paragraph problem; *Goals* vs *Out-of-scope*.
...
[Project context](#/ai-coding-context?id=project-context)
---------------------------------------------------------
...
[Versioning prompts](#/ai-coding-context?id=versioning-prompts)
---------------------------------------------------------------
...
[Commit messages](#/ai-coding-context?id=commit-messages)
---------------------------------------------------------
...
```
git diff --cached | llm "Generate a concise, descriptive commit message for these changes"Copy to clipboardErrorCopied
```

[Library context](#/ai-coding-context?id=library-context)
---------------------------------------------------------
...
- Use `curl -s https://context7.com/owner/repo/llms.txt` for https://github.com/owner/repo docsCopy to clipboardErrorCopied
```
...
[Project documentation](#/ai-coding-context?id=project-documentation)
---------------------------------------------------------------------
...
codex exec "Update README.md with project overview, setup, and usage examples"Copy to clipboardErrorCopied
```
...
[llms.txt](#/ai-coding-context?id=llmstxt)
------------------------------------------
...
[Instruction templates](#/ai-coding-context?id=instruction-templates)
---------------------------------------------------------------------
...
- **Logs**: [relevant error messages]Copy to clipboardErrorCopied
```

[Best practices and tips](#/ai-coding-context?id=best-practices-and-tips)
-------------------------------------------------------------------------
...
AI coding in the CLI](#/ai-coding-cli)

[Next

AI coding strategies](#/ai-coding-strategies)