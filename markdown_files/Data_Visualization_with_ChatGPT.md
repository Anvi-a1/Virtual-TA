---
title: "Data Visualization with ChatGPT"
original_url: "https://tds.s-anand.net/#/data-visualization-with-chatgpt?id=improving-visual-design"
downloaded_at: "2025-11-17T02:00:57.620809"
---
[Data Visualization with ChatGPT](#/data-visualization-with-chatgpt?id=data-visualization-with-chatgpt)
=======================================================================================================
...
[Prerequisites](#/data-visualization-with-chatgpt?id=prerequisites)
-------------------------------------------------------------------
...
[Finding Datasets](#/data-visualization-with-chatgpt?id=finding-datasets)
-------------------------------------------------------------------------
...
Please search online and suggest datasets matching these criteria.Copy to clipboardErrorCopied
```

[Ideating Stories](#/data-visualization-with-chatgpt?id=ideating-stories)
-------------------------------------------------------------------------
...
4. Initial approach for analysisCopy to clipboardErrorCopied
```

[Analysis and Visualization](#/data-visualization-with-chatgpt?id=analysis-and-visualization)
---------------------------------------------------------------------------------------------
...
5. Ensuring the visualization tells a clear storyCopy to clipboardErrorCopied
```

[Generating Web-Ready Code](#/data-visualization-with-chatgpt?id=generating-web-ready-code)
-------------------------------------------------------------------------------------------
...
5. Follows good web performance practicesCopy to clipboardErrorCopied
```

[Improving Visual Design](#/data-visualization-with-chatgpt?id=improving-visual-design)
---------------------------------------------------------------------------------------
...
5. Making it feel like a professional publication (e.g., New York Times style)Copy to clipboardErrorCopied
```

[Example Projects](#/data-visualization-with-chatgpt?id=example-projects)
-------------------------------------------------------------------------
...
[Best Practices](#/data-visualization-with-chatgpt?id=best-practices)
---------------------------------------------------------------------
...
[References](#/data-visualization-with-chatgpt?id=references)
-------------------------------------------------------------
...
Data Storytelling with LLMs](#/data-storytelling-with-llms)