...
original_url: "https://tds.s-anand.net/#/visualizing-animated-data-with-powerpoint?id=_99-perspiration"
downloaded_at: "2025-11-17T02:04:30.829829"
---
...
[How to make bar chart race in PowerPoint](#/visualizing-animated-data-with-powerpoint?id=how-to-make-bar-chart-race-in-powerpoint)
-----------------------------------------------------------------------------------------------------------------------------------
...
[Step-by-step guide to make Bar Chart Race in PowerPoint](#/visualizing-animated-data-with-powerpoint?id=step-by-step-guide-to-make-bar-chart-race-in-powerpoint)
-----------------------------------------------------------------------------------------------------------------------------------------------------------------

Here’s a quick walk-through of the techniques we used to create this.

### [Step 1: Create a 2-slide bar chart race](#/visualizing-animated-data-with-powerpoint?id=step-1-create-a-2-slide-bar-chart-race)
...
### [Step 2: Size the bars accurately](#/visualizing-animated-data-with-powerpoint?id=step-2-size-the-bars-accurately)
...
#### [Create the Star Wars Intro Crawl](#/visualizing-animated-data-with-powerpoint?id=create-the-star-wars-intro-crawl)
...
### [Step 3: Record voiceover](#/visualizing-animated-data-with-powerpoint?id=step-3-record-voiceover)
...
### [Step 4: Auto-play the voiceover](#/visualizing-animated-data-with-powerpoint?id=step-4-auto-play-the-voiceover)
...
To advance the slides automatically, select the Transition > Timing > Advance Slide > After option, and set it to *zero*. This will move to the next slide after all the animations (including audio) on the page are complete.

![transitions in PowerPoint](https://blog.gramener.com/wp-content/uploads/2019/07/image-5.png)

### [Step 5: Add background music](#/visualizing-animated-data-with-powerpoint?id=step-5-add-background-music)
...
### [Step 6: Export as MPEG-4](#/visualizing-animated-data-with-powerpoint?id=step-6-export-as-mpeg-4)
...
#### [99% perspiration](#/visualizing-animated-data-with-powerpoint?id=_99-perspiration)
...
*But we chose the manual approach consciously*. While prototyping, it allowed us to change course mid-way easily.
