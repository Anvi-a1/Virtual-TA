---
title: "AI coding strategies"
original_url: "https://tds.s-anand.net/#/ai-coding-strategies?id=code-review-automation"
downloaded_at: "2025-11-17T01:52:39.545354"
---
[AI Coding Strategies](#/ai-coding-strategies?id=ai-coding-strategies)
======================================================================
...
[Voice-to-code workflow](#/ai-coding-strategies?id=voice-to-code-workflow)
--------------------------------------------------------------------------
...
[Meta-prompting & optimization](#/ai-coding-strategies?id=meta-prompting-amp-optimization)
------------------------------------------------------------------------------------------
...
npx -y @openai/codex exec "Write a specific, actionable prompt to fix the login bug"Copy to clipboardErrorCopied
```
...
Pass *this* prompt to a coding agent to generate the code changes. This increases the chance of success in a **single-shot**.
...
[Sub-agents](#/ai-coding-strategies?id=sub-agents)
--------------------------------------------------

Coding agent context windows fill up fast, leading to forgotten functions, broken suggestions, and inefficiency.

Sub-agents are a way around this. Instead of using the same agent thread, it spawns tasks to dedicated agents for specialized tasks (e.g., file creation, git commits, running tests). Each runs in its *own* context window, so their token usage doesn’t drain the main agent’s memory.
...
[Parallel agents](#/ai-coding-strategies?id=parallel-agents)
------------------------------------------------------------
...
[Test-driven AI development](#/ai-coding-strategies?id=test-driven-ai-development)
----------------------------------------------------------------------------------
...
[Reset over repair](#/ai-coding-strategies?id=reset-over-repair)
----------------------------------------------------------------
...
### [Fast feedback loops](#/ai-coding-strategies?id=fast-feedback-loops)
...
[Code review automation](#/ai-coding-strategies?id=code-review-automation)
--------------------------------------------------------------------------
