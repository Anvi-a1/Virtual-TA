---
title: "Data Storytelling with LLMs"
original_url: "https://tds.s-anand.net/#/data-storytelling-with-llms?id=topic-modeling"
downloaded_at: "2025-11-17T02:00:31.071050"
---
[Data Storytelling with LLMs](#/data-storytelling-with-llms?id=data-storytelling-with-llms)
===========================================================================================
...
[Prerequisites](#/data-storytelling-with-llms?id=prerequisites)
---------------------------------------------------------------
...
[Data Engineering with LLMs](#/data-storytelling-with-llms?id=data-engineering-with-llms)
-----------------------------------------------------------------------------------------

### [Web Scraping](#/data-storytelling-with-llms?id=web-scraping)
...
4. Parse the data into an array of JSON objects with message detailsCopy to clipboardErrorCopied
```
...
### [Data Cleaning](#/data-storytelling-with-llms?id=data-cleaning)
...
4. Handle special cases (e.g., system messages, deleted content)Copy to clipboardErrorCopied
```

[Data Analysis with LLMs](#/data-storytelling-with-llms?id=data-analysis-with-llms)
-----------------------------------------------------------------------------------

### [Topic Modeling](#/data-storytelling-with-llms?id=topic-modeling)
...
4. Add cluster labels to original datasetCopy to clipboardErrorCopied
```

### [Pattern Discovery](#/data-storytelling-with-llms?id=pattern-discovery)
...
5. Interpret each as a story with human appealCopy to clipboardErrorCopied
```

[Best Practices](#/data-storytelling-with-llms?id=best-practices)
-----------------------------------------------------------------
...
[Example Workflow](#/data-storytelling-with-llms?id=example-workflow)
---------------------------------------------------------------------

1. **Data Collection**:

   ```
   Write code to scrape/collect data from [source]Copy to clipboardErrorCopied
   ```
2. **Data Cleaning**:

   ```
   Identify and fix data quality issues in this datasetCopy to clipboardErrorCopied
   ```
3. **Analysis**:

   ```
   What are the most interesting patterns in this data?
   Write code to analyze and visualize them.Copy to clipboardErrorCopied
   ```
4. **Visualization**:

   ```
   Create beautiful visualizations using [tool]
   Make them publication-quality with proper stylingCopy to clipboardErrorCopied
   ```
5. **Storytelling**:

   ```
   Write a compelling narrative around these insights
   Include surprising findings and human interestCopy to clipboardErrorCopied
   ```

[Tips for Better Results](#/data-storytelling-with-llms?id=tips-for-better-results)
-----------------------------------------------------------------------------------
...
[References](#/data-storytelling-with-llms?id=references)
---------------------------------------------------------
