---
title: "Project 2"
original_url: "https://tds.s-anand.net/#/project-llm-analysis-quiz?id=scoring"
downloaded_at: "2025-11-17T02:02:18.940623"
---
[Project: LLM Analysis Quiz](#/project-llm-analysis-quiz?id=project-llm-analysis-quiz)
======================================================================================
...
[Prompt Testing](#/project-llm-analysis-quiz?id=prompt-testing)
---------------------------------------------------------------
...
[API Endpoint Quiz Tasks](#/project-llm-analysis-quiz?id=api-endpoint-quiz-tasks)
---------------------------------------------------------------------------------
...
### [Test your endpoint](#/project-llm-analysis-quiz?id=test-your-endpoint)
...
[Viva](#/project-llm-analysis-quiz?id=viva)
-------------------------------------------
...
[Scoring](#/project-llm-analysis-quiz?id=scoring)
-------------------------------------------------
